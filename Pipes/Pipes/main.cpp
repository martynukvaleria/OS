...
int main()
{
    ...
    if (!CreateProcess(reinterpret_cast<LPCSTR>(pathMProcess), NULL, NULL, NULL, TRUE, 0, NULL, NULL, &startInfoProcessM, &processM_Info)) {
        return 1;
    }
    ...
    if (!CreateProcess(reinterpret_cast<LPCSTR>(pathAProcess), NULL, NULL, NULL, TRUE, 0, NULL, NULL, &startInfoProcessA, &processA_Info)) {
        closeAllProcesses();
        return 1;
    }
    ...
    if (!CreateProcess(reinterpret_cast<LPCSTR>(pathPProcess), NULL, NULL, NULL, TRUE, 0, NULL, NULL, &startInfoProcessP, &processP_Info)) {
        closeAllProcesses();
        return 1;
    }
    ...
    if (!CreateProcess(reinterpret_cast<LPCSTR>(pathSProcess), NULL, NULL, NULL, TRUE, 0, NULL, NULL, &startInfoProcessS, &processS_Info)) {
        closeAllProcesses();
        return 1;
    }
